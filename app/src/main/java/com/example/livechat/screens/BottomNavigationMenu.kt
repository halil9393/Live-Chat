        ...
        for (item in BottomNavigationItem.values()) {
            Image(
                ...
                modifier = Modifier
                    ...
                    }, colorFilter = if(item==selectedItem) androidx.compose.ui.graphics.ColorFilter.tint(color = Color.Black) else androidx.compose.ui.graphics.ColorFilter.tint(Color.Gray)
            )
        }
    }
